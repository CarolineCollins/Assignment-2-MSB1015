...
This query is from the lecture slides and returns descriptors
whatever they are

```{r}
sparql_query_descr <- 'SELECT * WHERE {?s ?p ?o . } LIMIT10'
resultsdescr = query_wikidata(sparql_query_descr)
resultsdescr
# is.data.frame(sparql_query_descr$results)
```
